...
public class AnisotropicDiffusion {
    ...
    public AnisotropicDiffusion(BufferedImage inputImg, float D0, float K) {
        this.K = K;
...
//        constr.setAccessible(true)
        ...
        this.delX = delX;
        this.delY = delY;
        this.kernelSource = readFile("resources/kernels/AnisotropicDiffusionExt.cl");
    ...
    public BufferedImage convolve() {
        ...
        for (int i = 0; i < steps; i++) {
            ...
            clSetKernelArg(kernel, 4, Sizeof.cl_float, Pointer.to(new float[]{K}));
            clSetKernelArg(kernel, 5, Sizeof.cl_float, Pointer.to(new float[]{D0}));
...
//        return new BufferedImage(sizeX, sizeY, BufferedImage.TYPE_BYTE_GRAY);
    ...
    private void initCL() {
        ...
        // Create the kernel
        kernel = clCreateKernel(cpProgram, "AnisotropicDiffusion", null);
